...
{	
	...
	public static void main(String[] args)
	{
		...
		*/
		...
		//boolean visual1=true;
		//String fileName="replay1.txt";
		//exec.runGameTimedRecorded((new MyPacMan()),new Legacy2TheReckoning(),visual1,fileName);
		//exec.replayGame("replay1.txt",visual);
